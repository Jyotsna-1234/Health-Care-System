...
public class TestConstants {
	...
	public static final String USER_ALREADY_EXIST="id already exist";
	
	public static final String USER_ADDED="User added successfully  ";
	
	public static final String USER_NOT_FOUND="User not found ";
	
	public static final String USER_ADD_URL="adduser";
	
	public static final String USER_DELETED=" user deleted successfully";
	
	public static final String USER_DELETE_URL="removeuser/{userId}";
	
	public static final String VIEW_ALL_USERS_URL="viewallusers";
	
	
	public static final String VIEW_USER_URL="viewuser/{phoneNo}";
